...
public:
  ...
  float Total_delta_5x5;
  float Total_energy_5x5;
  float Total_ion_energy_5x5;
  float Total_nonion_energy_5x5;
  ...
  float Total_energy[25];
  float Total_nonion_energy[25];
  ...
  int opPhoton_n[25];
  int opPhoton_n_ext[25];
  int opPhoton_n_det[25];
