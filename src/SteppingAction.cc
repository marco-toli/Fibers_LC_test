...
//      cout << "optical photon ! " << endl;
    ...
    if( //(CreateTree::Instance()->Timing() && processName != "Cerenkov") ||
        (!CreateTree::Instance()->Timing()) || processName == "Cherenkov")
...
//       cout << " tracing optical photons ... " << endl;
	...
	if (processName == "Cerenkov") CreateTree::Instance()->opPhoton_n_ext_type.push_back(0);
	...
	if (processName == "Cerenkov") CreateTree::Instance()->opPhoton_n_det_type.push_back(0);
